...
const API_KEY = "adc5fefce26bf9431b0dfadfc15249a9";
...
function getWeatherData() {
  navigator.geolocation.getCurrentPosition((success) => {
    ...
    fetch(
      `https://api.openweathermap.org/data/2.8/onecall?lat=${latitude}&lon=${longitude}&exclude=hourly,minutely&units=metrics&appid=${API_KEY}`
    )
      .then((res) => res.json())
      .then((data) => {
        console.log(data);
...
<div class="weather-item">
  ...
  <div>${Math.round(wind_speed * 3.6)}</div>
  </div>
